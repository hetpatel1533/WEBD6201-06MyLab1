...
function displayAbout()
{
  ...
  let title = document.createElement("h1");
    ...
    image.src = "https://lh3.googleusercontent.com/nUxmTY67uT3MmY5Q07VMkmJoUG9LrXQhO07YmVgxS8ktcYlBodUB5ny8qShTPfunPjM3zkDeq6_j3LNQhnLQ3ZUcUZly9ar6dCTZyyE";
...
// This function is made to run the above functions on correct order
function Start()
    {
        ...
        footer.innerHTML = `<nav class="navbar fixed-bottom text-white navbar-dark bg-dark justify-content-center">
          <p class="my-2"><i class="far fa-copyright"></i> My first Lab, 2023.</p>
        </nav>`;
